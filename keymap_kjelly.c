...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_LSFT,  KC_LSFT,  TAPK(KC_LCTL,KC_Z),    TAPK(KC_LALT,KC_X),    TAPK(KC_LGUI,KC_C),    KC_V,    KC_B,    KC_N,    KC_M,    TAPK(KC_RGUI,KC_COMM),  TAPK(KC_RALT,KC_DOT),    TAPK(KC_RCTL,KC_SLSH),  KC_FN11,  KC_FN1,       \
         KC_FN12, KC_FN22,  KC_FN23,           KC_SPC,                 KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT),
    ...
    KC_TRNS, KC_TRNS, KC_APP, KC_NLCK, KC_PSCR, KC_HOME, KC_PGUP, KC_FN10, KC_FN0, KC_FN0,  KC_FN0,  KC_FN9,  KC_RSFT, KC_TRNS,      \
