...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_LCTL,  KC_LSFT,  TAPK(KC_LCTL,KC_Z),    TAPK(KC_LALT,KC_X),    TAPK(KC_LGUI,KC_C),    KC_V,    KC_B,    KC_N,    KC_M,    TAPK(KC_RGUI,KC_COMM),  TAPK(KC_RALT,KC_DOT),    TAPK(KC_RCTL,KC_SLSH),  KC_FN11,  KC_FN1,       \
         KC_FN12, KC_FN23,  KC_FN22,           KC_SPC,                 KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT),

    /* Layer 1 */
    KEYMAP_KJELLY(
         KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_FN21,  KC_FN19,  \
         KC_CAPS, KC_GRV, KC_FN9, KC_BSLS, KC_FN10,KC_NO  , KC_NO,    KC_MINS,  KC_FN17, KC_EQL,    KC_FN16,  KC_INS,  KC_PAUS, KC_DEL,      \
         KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE, KC_PGDN, KC_HOME, KC_LEFT,  KC_DOWN,  KC_UP,   KC_RIGHT,  KC_BSPC,  KC_DEL,  KC_PENT,
    KC_TRNS, KC_TRNS, KC_APP, KC_NLCK, KC_PSCR, KC_END, KC_PGUP, KC_FN10, KC_FN0, KC_FN0,  KC_FN0,  KC_FN9,  KC_RSFT, KC_TRNS,      \
